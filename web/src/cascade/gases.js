...
export const GASES = {
  ...
  SIL: new Gas(
    ...
    166.0,
    null,
    "Phase curve: zgralewski diagram (2026-04-19). Thermal properties: Stationeers Wiki Module:Gas/data (2026-09-02).",
    2.0,
    1.3887,
  ),
  ALC: new Gas(
    ...
    18.0,
    322.01067368754275,
    "Phase curve: zgralewski diagram (2026-04-19). Thermal properties: Stationeers Wiki Module:Gas/data (2026-09-02). Alcohol evaporates into methane in-game.",
    1.3606,
    1.2204,
  ),
  HCl: new Gas(
